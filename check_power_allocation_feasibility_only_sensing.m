function [feasibility_output, powers_only_UEs] = check_power_allocation_feasibility_only_sensing(precoding_vectors, channel_vectors, K, T, SINR_th_db, P_t_max)
