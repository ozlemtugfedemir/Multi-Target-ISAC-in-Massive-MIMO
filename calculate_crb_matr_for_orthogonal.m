function cramer_output = calculate_crb_matr_for_orthogonal(optimal_outputs, output_parameters, global_variables)
...
for cnt_tars = 1:T
SNR = (N/2)*abs(alpha(cnt_tars))^2/noise_var;
